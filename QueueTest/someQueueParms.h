...
class QueueParms : public Ris::BaseCmdLineParms
{
public:
...
#ifdef _SOMEQUEUEPARMS_CPP_
   QueueParms gQueueParms;
#else
   extern QueueParms gQueueParms;
#endif
