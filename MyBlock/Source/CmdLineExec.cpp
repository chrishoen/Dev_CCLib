...
void CmdLineExec::executeGoA1(Ris::CmdLineCmd* aCmd)
{
   ...
   Some::MyBlockA* tX1 = Some::MyBlockA::create();
   CC::showBlockPool(Some::cBlockPoolIndex_MyBlockA);
   tX1->method1();
...
void CmdLineExec::executeGoA2(Ris::CmdLineCmd* aCmd)
{
   ...
   Some::MyBlockA* tX1 = Some::MyBlockA::create();
   Some::MyBlockA* tX2 = Some::MyBlockA::create();
   CC::showBlockPool(Some::cBlockPoolIndex_MyBlockA);
   tX1->method1();
   tX2->method1();
...
void CmdLineExec::executeGoA4(Ris::CmdLineCmd* aCmd)
{
   ...
   Some::MyBlockA* tX1 = Some::MyBlockA::create();
   Some::MyBlockA* tX2 = Some::MyBlockA::create();
   Some::MyBlockA* tX3 = Some::MyBlockA::create();
   Some::MyBlockA* tX4 = Some::MyBlockA::create();
   CC::showBlockPool(Some::cBlockPoolIndex_MyBlockA);
   if (tX1) tX1->method1();
   if (tX2) tX2->method1();
   if (tX3) tX3->method1();
