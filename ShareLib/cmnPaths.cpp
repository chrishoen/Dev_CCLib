...
std::unique_ptr<std::string> get_filepath_from_id(int aFileId)
{
   ...
   case cFile_TestStroke1: return get_data_filepath("TEST_STROKE1.SGSTN");
   case cFile_TestStroke2: return get_data_filepath("TEST_STROKE2.SGSTN");
   ...
   case cFile_TTestScript_Test2: return get_files_filepath("script_tran_test2.txt");
   default:
