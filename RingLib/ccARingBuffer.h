...
public:
   ...
   // Constructor.
   ARingBufferWriter();
   virtual ~ARingBufferWriter() {};
   void resetVars();
   virtual void resetTest() {}
   void initialize(ARingBufferState* aARingBufferState, void* aElementArrayMemory);
...
public:
   ...
   // Constructor.
   ARingBufferReader();
   virtual ~ARingBufferReader() {};
   void resetVars();
   virtual void resetTest() {}
   void initialize(ARingBufferState* aARingBuffer, void* aElementArrayMemory);
