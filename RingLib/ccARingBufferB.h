...
public:
   ...
   // Constructor.
   ARingBufferBWriter();
   virtual ~ARingBufferBWriter() {};
   void resetVars();
   virtual void resetTest() {}
   void initialize(ARingBufferBState* aARingBufferBState, void* aElementArrayMemory);
...
public:
   ...
   // Constructor.
   ARingBufferBReader();
   virtual ~ARingBufferBReader() {};
   void resetVars();
   virtual void resetTest() {}
   void initialize(ARingBufferBState* aARingBufferB, void* aElementArrayMemory);
