...
void BlockPoolLFFreeList::allocate(void** aBlockPointer,BlockHandle* aBlockHandle)
{
   int tBlockIndex = 0;
   ...
   if(!mBlockIndexStack.pop(tBlockIndex))
   {
      ...
      *aBlockPointer = 0;
      ...
      printf("BlockPoolLFFreeList STACK EMPTY %d\n",BaseClass::mPoolIndex);
      return;
   }
